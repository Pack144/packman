    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "name",
                    models.CharField(
                        help_text="e.g. Pack Meeting, Den Meeting, Camp out, etc.",
                        max_length=32,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "published",
                    models.BooleanField(default=True, verbose_name="Show on iCal"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="events", to="documents.Document"
            ),
        ),
        migrations.AddField(
            model_name="event",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["name", "venue", "location", "start", "end", "category"],
                name="calendars_e_name_7ac5d3_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="packyear",
