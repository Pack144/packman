...
class Campaign(TimeStampedModel):
    ...
    class Meta:
        ...
        permissions = [("generate_order_report", _("Can generate an order report"))]
    ...
    def clean(self):
        ...
        # NOTE: use localtime() so late-evening opens don't cross into the next UTC day.
        if self.delivery_available < timezone.localtime(self.ordering_opens).date():
            raise ValidationError(
