...
urlpatterns = [
    ...
    path("leaderboard/", OrderLeaderboardRedirectView.as_view(), name="order_leaderboard_legacy"),
    path("leaderboards/", OrderLeaderboardView.as_view(), name="order_leaderboard"),
    path(
        "leaderboards/<int:campaign>/",
