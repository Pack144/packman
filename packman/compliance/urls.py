...
urlpatterns = [
    ...
    path("den/", views.DenComplianceDashboardView.as_view(), name="den_dashboard"),
    path("den/<int:year>/", views.DenComplianceDashboardView.as_view(), name="den_dashboard_by_year"),
