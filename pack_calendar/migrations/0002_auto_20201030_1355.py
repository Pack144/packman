...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(event_migration_prep, migrations.RunPython.noop, elidable=True),
        migrations.RunPython(category_migration_prep, migrations.RunPython.noop, elidable=True),
    ]
